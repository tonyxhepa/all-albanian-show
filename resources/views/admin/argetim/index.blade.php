           ...
           @if($argetims)
               ...
               @foreach($argetims as $post)
                   ...
                   <tr>
                       ...
                       <td><a href="{{ url('/admin/argetim/'. $post->id .'/edit') }}"><button class="btn btn-primary">edit</button></a> </td>
                       <td>{!! Form::open(['method'=>'DELETE', 'action'=>['Admin\ArgetimController@destroy', $post->id]]) !!}
