        ...
        @if($makinat)
            ...
            @foreach($makinat as $post)
                ...
                <tr>
                    ...
                    <td><a href="{{ url('/admin/makina/'. $post->id .'/edit') }}"><button class="btn btn-primary">edit</button></a> </td>
                    <td>{!! Form::open(['method'=>'DELETE', 'action'=>['Admin\MakinaController@destroy', $post->id]]) !!}
