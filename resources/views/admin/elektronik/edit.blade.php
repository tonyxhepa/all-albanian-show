...
@section('content')
    ...
    <form method="POST" action="{{ route('elektronik.update', $post->id) }}" enctype="multipart/form-data">
        ...
        <div id="app">
            <div class="form-group">
                <label for="car_make_id">Kategoria</label>
        ...
        <div id="app-1">
            <div class="form-group">
                <label for="title">Zgjidh Shtetin:</label>
                <select name="country_id" id="country_id" class="form-control" v-model="country_id" v-on:change="getCountryModel()" v-bind:disabled="disableWhenSelect">
                    <option value="{{ $post->country->id }}">{{ $post->country->name }}</option>
            ...
            <div class="form-group" v-show="cityModelShow">
                <label for="title">Zghidh Qytetin</label>
