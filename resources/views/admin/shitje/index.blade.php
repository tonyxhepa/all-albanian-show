        ...
        @if($shitjet)
            ...
            @foreach($shitjet as $post)
                ...
                <tr>
                    ...
                    <td><a href="{{ url('/admin/shitje/'. $post->id .'/edit') }}"><button class="btn btn-primary">edit</button></a> </td>
                    <td>{!! Form::open(['method'=>'DELETE', 'action'=>['Admin\ShtijeController@destroy', $post->id]]) !!}
