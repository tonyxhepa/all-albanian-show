                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @if(!Auth::user()->profile)
                            <li> <a href="{{ route('profile.create', Auth::user()->slug) }}" class="list-group-item">create</a></li>
                        @else
                            <li> <a href="{{  url(Auth::user()->slug. '/profile/'. Auth::user()->profile->id) }}"
                                    class="list-group-item">Shikoje</a></li>
                            <li><a href="{{  url(Auth::user()->slug. '/profile/'. Auth::user()->profile->id .'/edit') }}"
                                   class="list-group-item">Editoje</a></li>
                        @endif
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Makina <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li> <a href="{{ url(Auth::user()->slug. '/profile/makinaime/create') }}" class="list-group-item">Publiko te re</a></li>
                        <li> <a href="{{ route('makinaime.index', Auth::user()->slug) }}" class="list-group-item">Makinat
                                e mia</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pronat <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li> <a href="{{ url(Auth::user()->slug. '/profile/pronaime/create') }}" class="list-group-item">Publiko te re</a></li>
                        <li> <a href="{{ route('pronaime.index', Auth::user()->slug) }}" class="list-group-item">Pronat e
                                mia</a></li>

                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Punet <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li> <a href="{{ url(Auth::user()->slug. '/profile/punaime/create') }}" class="list-group-item">Publiko te re</a></li>
                        <li> <a href="{{ route('punaime.index', Auth::user()->slug) }}" class="list-group-item">Punet e
                                mia</a></li>

                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Elektroniket <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li> <a href="{{ url(Auth::user()->slug. '/profile/elektroniketemia/create') }}" class="list-group-item">Publiko te re</a></li>
                        <li> <a href="{{ route('elektroniketemia.index', Auth::user()->slug) }}" class="list-group-item">Elektroniket e
                                mia</a></li>

                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Shtijet <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li> <a href="{{ url(Auth::user()->slug. '/profile/shitjetemia/create') }}" class="list-group-item">Publiko te re</a></li>
                        <li> <a href="{{ route('shitjetemia.index', Auth::user()->slug) }}" class="list-group-item">Elektroniket e
                                mia</a></li>
