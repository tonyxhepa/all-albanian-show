...
class ElektroniksController extends Controller
{
    ...
    public function index()
    {
        ...
        $elektronik_i_fat = Elektronik::where('i_faturuar',  true)->orderBy('updated_at', 'desc')->get();
        return view('admin.elektronik.index', compact('elektronik', 'elektronik_i_fat'));
    }
    ...
    public function store(ElektronikCreateRequest $request)
    {
        ...
        if ($request->has('i_faturuar')){
            $i_faturuar = $request->has('i_faturuar') ? true : false;
