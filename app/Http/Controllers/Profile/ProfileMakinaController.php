...
class ProfileMakinaController extends Controller
{
    public function index($slug, Menu $menu)
    {
        ...
        return view('profile.makinaime.index', compact('makinat', 'slug', 'menu'));
    ...
    public function create(Menu $menu)
    {
        ...
        return view('profile.makinaime.create', compact('car_make', 'countries', 'menu'));
    }
    ...
    public function edit($slug,$id, Menu $menu)
    {
        ...
        return view('profile.makinaime.edit', compact('post', 'car_make', 'countries', 'user', 'menu'));
