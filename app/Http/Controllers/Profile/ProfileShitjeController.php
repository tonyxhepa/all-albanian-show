...
class ProfileShitjeController extends Controller
{
    public function index($slug, Menu $menu)
    {
        ...
        return view('profile.shjitjetemia.index', compact('shitjet', 'menu'));
    }
    ...
    public function create(Menu $menu)
    {
        ...
        return view('profile.shjitjetemia.create', compact('shitje_cats', 'countries', 'menu'));
    }
    ...
    public function edit($slug,$id, Menu $menu)
    {
        ...
        return view('profile.shjitjetemia.edit', compact('post','user', 'shitje_cats', 'countries', 'menu'));
    }
    /**
