...
class ProfileElektronikController extends Controller
{
    public function index($slug, Menu $menu)
    {
        ...
        return view('profile.elektroniketemia.index', compact('elektronik', 'menu'));
    }
    ...
    public function create(Menu $menu)
    {
        ...
        return view('profile.elektroniketemia.create', compact('elektronik_cats', 'countries', 'menu'));
    }
    ...
    public function edit($slug, $id, Menu $menu)
    {
        ...
        $user  = User::where('slug', $slug)->first();
        $countries = Country::pluck('name', 'id')->all();
        return view('profile.elektroniketemia.edit', compact('post', 'user', 'countries', 'elektronik_cats', 'menu'));
    }
    /**
