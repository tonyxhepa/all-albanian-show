...
use App\Country;
use App\Http\Controllers\Show\MagazinaCatController;
...
class ProfilePronaController extends Controller
{
    public function index($slug, Menu $menu)
    {
        ...
        return view('profile.pronaime.index', compact('pronat', 'menu'));
    }
    ...
    public function create(Menu $menu)
    {
        ...
        return view('profile.pronaime.create', compact('prona_cats', 'countries', 'menu'));
    }
    ...
    public function edit($slug, $id, Menu $menu)
    {
        //
        $prona_cats = PronaCat::pluck('name', 'id')->all();
        $countries = Country::pluck('name', 'id')->all();
        ...
        return view('profile.pronaime.edit', compact('post','user', 'prona_cats', 'countries', 'menu'));
    }
    /**
