...
class ProfilePunaController extends Controller
{
    public function index($slug, Menu $menu)
    {
        ...
        $puna = $user->puna->all();
        return view('profile.punaime.index', compact('puna', 'menu'));
    }
    ...
    public function create(Menu $menu)
    {
        ...
        $oraret = Orari::pluck('name', 'id')->all();
        $countries = Country::pluck('name', 'id')->all();
        return view('profile.punaime.create', compact('profesioni', 'oraret', 'countries', 'menu'));
    }
    ...
    public function edit($slug,$id, Menu $menu)
    {
        ...
        return view('profile.punaime.edit', compact('post','user', 'profesioni','oraret', 'countries', 'menu'));
    }
